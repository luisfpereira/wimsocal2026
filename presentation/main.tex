...
\begin{column}{0.6\textwidth}
	$$x_{k+1}=T\left(x_k\right)$$
	where state space (parameters) $X \subseteq \mathbb{R}^d$, map (update rule) $T: X \to X$, and iteration $k \in \mathbb{N}$
\end{column}
\begin{column}{0.4\textwidth}
    \begin{center}
     \includegraphics[width=.8\textwidth]{loss-landscape.png}
     \end{center}
\end{column}
\end{columns}
